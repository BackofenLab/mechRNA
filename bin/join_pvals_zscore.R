...
write.table(file=paste(args[1],".pvalues.csv", sep = ""), data.table[order(decreasing = FALSE, as.numeric(data.table[,"Joint_P"])),], sep = ",", row.names=FALSE, col.names=TRUE, quote=FALSE)
